...
ONF_TT_FLOW_CTRL_PACK_STR = '!B3xI' 
ONF_TT_FLOW_CTRL_SIZE = 8 
assert (calcsize(ONF_TT_FLOW_CTRL_PACK_SIZE) ==
...
ONFERR_ET_UNKNOWN = 2400
ONFERR_ET_BAD_CMD = 2401
ONFERR_ET_BAD_PORT = 2402
ONFERR_ET_BAD_ENTRY_TYPE = 2403
ONFERR_ET_BAD_FLOW_ID = 2404
OEFERR_ET_BAD_BUF_ID = 2405
