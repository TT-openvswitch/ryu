...
# exp_code values for OFPET_EXPERIMENTER used for TT (chen weihang)
ONFERR_ET_TFC_UNKNOWN = 2400
ONFERR_ET_TFC_BAD_CMD = 2401
ONFERR_ET_TFC_BAD_PORT = 2402
ONFERR_ET_TFC_BAD_ENTRY_TYPE = 2403
ONFERR_ET_TFC_BAD_FLOW_ID = 2404
OEFERR_ET_TFC_BAD_BUF_ID = 2405
ONFERR_ET_TFC_FLOW_NUM_ERROR = 2406
ONFERR_ET_TFC_TIMEOUT = 2407
